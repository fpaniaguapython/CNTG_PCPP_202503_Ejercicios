...
factura_1 = Factura(100)
factura_2 = Factura(102)

factura_1.metodo_instancia() # Ejecutando método de instancia...: 100
factura_1.metodo_clase() # Ejecuntando método de clase...: Soy un atributo de clase
factura_1.metodo_estatico()# Ejecutando método estático...

factura_2.metodo_instancia() # Ejecutando método de instancia...: 102
factura_2.metodo_clase() # Ejecuntando método de clase...: Soy un atributo de clase
...
factura_1.metodo_clase() # Ejecuntando método de clase...: Soy un atributo de clase modificado
factura_2.metodo_clase() # Ejecuntando método de clase...: Soy un atributo de clase modificado
